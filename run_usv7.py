...
# 1. 配置中心
# ==========================================
WEBAPP_URL = "https://script.google.com/macros/s/AKfycbwge8q3lsOmZHRLNx_v73_3Qr_pQ9hihaytx1rIftx6TcTTM176y_ygG5wCeUyGOjg/exec"
...
def run_v20_engine():
    ...
    row1 = ["🏰 [V20.0 终极共振对齐版]", "", "", "", "更新时间(BJ):", now_str, "", "", "", "", "", "", "", "", "", "", ""]
    ...
    try:
        ...
        print(f"🎉 同步完成 | 宽度: {breadth:.1f}% | 反馈: {resp.text}")
